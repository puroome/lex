...
const quizMode = {
    ...
    renderQuiz(quizData) {
        ...
        choices.forEach((choice, index) => {
            ...
            li.className = 'choice-item border-2 border-gray-300 py-2 px-4 rounded-lg cursor-pointer flex items-start transition-all text-2xl hover:border-blue-500 hover:bg-blue-50';
