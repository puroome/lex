...
const quizMode = {
    ...
    renderQuiz(quiz) {
        ...
        const wordInfo = quiz.question.word_info;
        const hasSample = wordInfo.sample && wordInfo.sample.trim() !== '';
        ...
        const hasExplanation = wordInfo.explanation && wordInfo.explanation.trim();
        this.elements.explanationBtn.style.display = hasExplanation ? 'block' : 'none';
    },
    ...
    async handleFlip(type) {
        const wordInfo = this.state.currentQuiz.question.word_info;
        if (type === 'sample' && (!wordInfo.sample || !wordInfo.sample.trim())) {
    ...
    updateBackContent(type) {
        const { word, sample, explanation } = this.state.currentQuiz.question.word_info;
